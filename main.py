...
from sharp_ratio_function import findSharpratio, inputSharpratio, verifySharpratio
...
def ampo(objective):
    ...
    print('Best fitness:' + str(findSharpratio(best_solution)))
...
def getData(input_sol):
    value_sharpratio, value_return, value_risk = verifySharpratio(
        input_sol, rec=1)
    print("Sharp Ratio, Return and Risk for the input solution are {}, {} and {} respectively.".format(
        value_sharpratio, value_return, value_risk))
